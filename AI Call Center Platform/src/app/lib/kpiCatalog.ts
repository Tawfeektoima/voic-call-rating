import { KpiCatalogItem } from './types';
...
export function getKpiDefinition(kpiKey?: string | null) {
  return KPI_CATALOG.find((item) => item.key === kpiKey) || null;
}

export function formatKpiValue(value: number | null | undefined, unit: KpiCatalogItem['unit']) {
